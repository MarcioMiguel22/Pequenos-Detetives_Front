    ...
    <div className="home-page">
      <div className="hero-section">
        ...
        <p className="intro-text">
          Bem-vindo ao Pequenos Detetives, um site interativo e cheio de mistérios 
          feito especialmente para crianças curiosas e espertas! 
          Embarque numa jornada divertida resolvendo enigmas simples, 
      ...
      <div className="features-section">
        <div className="feature-card">
          ...
          <h3>Para Crianças de 5 a 10 anos</h3>
          <p>Desafios adaptados para diferentes idades e habilidades</p>
        </div>
      ...
      <div className="cta-section">
        ...
        <p>Entre nessa missão com os Pequenos Detetives!</p>
